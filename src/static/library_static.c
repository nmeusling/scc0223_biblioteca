...
//        lib->students.elements[i].next = i+1;
//    }
...
//        lib->students.elements[lib->students.last].next = index;
//    }
...
//    if (strcmp(lib->students.elements[index].name, name) == 0) {
//        *prev_stud = -1;
//        return 0;
//    }
//    while (lib->students.elements[index].next != -1) {
//        if (strcmp(lib->students.elements[lib->students.elements[index].next].name, name) == 0) {
//            *prev_stud =index;
//            return 0;
//        }
//        index = lib->students.elements[index].next;
//
//    }
//    return 1;
//}
...
//        return 1;
//    //If the student is the first in the list
//    if (compare_int_array(lib->students.elements[index].nusp, nusp, MAX_NUSP_SIZE) == 0) {
//        *prev_stud = -1;
//        return 0;
//    }
//    while (lib->students.elements[index].next != -1) {
//        if (compare_int_array(lib->students.elements[lib->students.elements[index].next].nusp, nusp, MAX_NUSP_SIZE) == 0) {
//            *prev_stud = index;
//            return 0;
//        }
//        index = lib->students.elements[index].next;
...
//    if (prev_stud == -1) {
//        lib->students.first = lib->students.elements[index].next;
//        free_node_studentlist(&lib->students, index);
//        //student was only element, list is now empty
//        if (lib->students.first == -1)
//            lib->students.last = -1;
//        delete_email_stack(&lib->students.elements[index].emails);
//        remove_student_all_waitlists(&lib->books, &lib->students.elements[index]);
//        free_node_studentlist(&lib->students, index);
//        return 0;
//    }
//        //student is last but not only element in list
//    else if(lib->students.elements[prev_stud].next == lib->students.last)
//    {
//        lib->students.last = prev_stud;
//    }
//    //student is not 1st element
//    index = lib->students.elements[prev_stud].next;
//    lib->students.elements[prev_stud].next = lib->students.elements[index].next;
//    delete_email_stack(&lib->students.elements[index].emails);
//    remove_student_all_waitlists(&lib->books, &lib->students.elements[index]);
//    free_node_studentlist(&lib->students, index);
//    return 0;
